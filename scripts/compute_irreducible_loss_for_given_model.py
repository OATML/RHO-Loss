...
def main():
    datamodule = CIFAR10DataModule(
        ...
        data_dir="/scratch-ssd/janner/goldiprox/data",
        batch_size=320,
        num_workers=4,
        pin_memory=True,
        shuffle=False,
    ...
    irreducible_loss_and_checks["irreducible_losses"] = (irreducible_loss_and_checks["irreducible_losses"]).cuda()

    # save_dir = "/Users/jbrauner/repos/goldiprox-hydra/outputs/pretrained_Resnet_test" # make sure this directory actually exists :-)
    save_dir = "/users/janner/goldiprox-hydra/outputs/pretrained_Resnet18" # make sure this directory actually exists :-)
    path = os.path.join(save_dir, "irred_losses_and_checks_gpu.pt") # save irred losses in same directory as model checkpoint
